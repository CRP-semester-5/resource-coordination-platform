...
CREATE TABLE users (
 ...
 email VARCHAR(255) NOT NULL UNIQUE, password_hash TEXT, phone VARCHAR(30) UNIQUE,
...
CREATE INDEX idx_guest_request_phone ON guest_request_contacts(contact_phone);
...
CREATE TABLE volunteers (
 ...
 available_time_range VARCHAR(100),
 max_hours_per_day VARCHAR(50),
 max_travel_distance VARCHAR(50),
 created_at TIMESTAMPTZ NOT NULL DEFAULT NOW(), updated_at TIMESTAMPTZ NOT NULL DEFAULT NOW(),
